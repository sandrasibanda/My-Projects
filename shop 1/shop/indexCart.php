...
<a id="btnEmpty" href="index.php?action=empty" onclick="alert('Purchaced Successfully!\n Cart Cleared... ')">CHECK OUT!</a>
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="indexCart.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction" onclick="alert('Item Removed Successfully!')"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
